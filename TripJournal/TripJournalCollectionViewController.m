...
- (void) pageView {
    ...
    QuickAddViewController *startingViewController = [self viewControllerAtIndex:0];
...
{
    NSUInteger index = ((QuickAddViewController*) viewController).pageIndex;
...
- (QuickAddViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    UINavigationController *navController = [self.storyboard instantiateViewControllerWithIdentifier:@"PageContentViewController"];
    QuickAddViewController *pageContentViewController = [[navController viewControllers] objectAtIndex:0];
    pageContentViewController.imageUrl = self.urls[index];
